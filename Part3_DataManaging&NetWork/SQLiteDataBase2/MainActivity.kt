package co.kr.sqlitedatabase2

import android.content.ContentValues
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import co.kr.sqlitedatabase2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        r.button2.setOnClickListener {
            ...
            val helper = DBHelper(this)
            // 테이블명 / 컬럼명(null이면 전체) /
            // 조건절 / 조건절 ? 에 바인딩될 배열(세번째 와 짝맞춤) / grouby절
            // having 절 / 정렬 기준
            val c1 = helper.writableDatabase.query("TestTable", null
